...
import { fileService, productDashboardService } from "@/services"
...
function CreateProductForm({
  ...
  const onSubmit = async (data: ProductFormValues) => {
    ...
    try {
      await productDashboardService.update(productID, data)
  ...
  useEffect(() => {
    async function getDetailProduct() {
      try {
        ...
        const product = await productDashboardService.getDetail(productID)
      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <Input {...register("category")} placeholder="Nhập danh mục" />
          </div>
